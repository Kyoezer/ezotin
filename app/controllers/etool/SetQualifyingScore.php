...
class SetQualifyingScore extends EtoolController{
    ...
    public function postSave(){
        ...
        if(!$object->validate($inputs)){
            return Redirect::to('etl/qualifyingscore')->withErrors($object->errors());
        }
        try{
            ...
            return Redirect::to('etl/qualifyingscore')->with('savedsuccessmessage','Record has been updated');
        }catch (Exception $e){
            throw $e;
        }
    }
