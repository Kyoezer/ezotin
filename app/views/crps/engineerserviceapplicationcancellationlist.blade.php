			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{URL::to('engineer/approveserviceapplicationcancelcertificateprocess/'.$engineerMyTaskList->Id.'/'.$engineerMyTaskList->CancelRequestId)}}" class="btn default btn-xs green-seagreen processaction"><i class="fa fa-edit"></i> Process</a>
							<a href="{{URL::to('dropapplication')}}?model=EngineerCancelCertificateModel&id={{$engineerMyTaskList->CancelRequestId}}&redirectUrl={{Request::path()}}" class="btn default btn-xs purple dropaction"><i class="fa fa-times"></i> Drop</a>
						</td>
					</tr>
					@empty
					<tr>
			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{URL::to('engineer/cancelcertificatelockapplication/'.$engineerList->CancelRequestId.'?redirectUrl=engineer/approvecertificatecancellationrequestlist')}}" class="btn default btn-xs green-seagreen pickaction"><i class="fa fa-edit"></i> Pick</a>
						</td>
					</tr>
					@empty
					<tr>
