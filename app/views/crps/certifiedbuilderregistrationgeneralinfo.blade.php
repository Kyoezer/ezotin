...
{{ HTML::script('assets/global/scripts/certifiedbuilder.js') }}
	@if(empty($certifiedbuilderGeneralInfo[0]->Id) && (int)$serviceByCertifiedbuilder==0)
	<script>
	 $('#certifiedbuildergeneralinforegistrationform').bootstrapValidator({
	    fields: {
	        NameOfFirm: {
	            validators: {
	                remote: {
	                    message: 'The Proposed Name for your firm is already taken. Try another name for your firm.',
	                   	url: "<?php echo CONST_SITELINK.'checkproposednamecertifiedbuilder'?>",
	                    delay: 2000
	                }
	            }
	        },
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-seagreen">
					...
					<span class="caption-subject">Certified Builder Registration (New Application) </span> - <span class="step-title">Step 1 of 4 </span>
				</div>
			</div>
					...
					<div class="form-body">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								{{ Form::open(array('url' => 'certifiedbuilder/mcertifiedbuildergeneralinfo','role'=>'form','id'=>'certifiedbuildergeneralinforegistrationform','files'=>true))}}
