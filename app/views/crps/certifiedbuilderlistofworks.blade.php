		...
		<table class="table table-bordered table-striped table-condensed flip-content">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						@if(Request::path()=="certifiedbuilder/editcompletedworklist" || Request::path()=="certifiedbuilder/worklist")
						<a href="{{URL::to('certifiedbuilder/workcompletionform/'.$lsitOfWork->Id)}}" class="btn default btn-xs green-seagreen"><i class="fa fa-edit"></i> View</a>
						@elseif(Request::path()=="certifiedbuilder/editbiddingformlist")
						<a href="{{URL::to('certifiedbuilder/biddingform?bidreference='.$lsitOfWork->Id)}}" class="btn default editaction btn-xs green-seagreen"><i class="fa fa-edit"></i> Edit</a>
						@endif
