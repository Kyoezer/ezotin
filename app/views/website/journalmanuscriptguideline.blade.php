...
<div>
	<div class="row">
		<div class="col-md-9" id="main_front">
			<p class="home"><a href="gnhjournal">Current </a>/ Manuscript preparation guideline to the author</p>
			<h4 class="text-primary"><strong>Manuscript preparation guideline to the author</strong></h4>
			    {{HTML::decode($content)}}
		</div>
		<div class="container">
			<div class="row">
