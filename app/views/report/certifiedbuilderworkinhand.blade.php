    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <i class="fa fa-cogs"></i>Certifiedbuilder's work in hand &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route('cb.certifiedbuilderworkinhand',$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route('cb.certifiedbuilderworkinhand',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
            </div>
        </div>
        <div class="portlet-body flip-scroll">
            ...
            @else
                ...
                <br/>
            @endif
            @forelse($singleCertifiedbuilder as $value)
            <div class="row">
                <div class="col-md-12">
