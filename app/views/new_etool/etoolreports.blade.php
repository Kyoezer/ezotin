...
function checkCID()
{
    ...
    $.ajax({
            ...
            ({
                type : "GET",             
                url : "http://119.2.104.81:8181/DNPDatahub/api/getRcscDetails?cid="+cid+"&token="+accessTokenData,   
                data : $('form').serialize(),
                cache : false,
                dataType : "json",  
                success : function(responseText, status, xhr) 
                {
                   ...
                   // checkHumanResource(cid, $('input[name="Id"]').val(),isEmployed);
                    ...
                    ({
                        type : "GET",             
                        url : "http://119.2.104.81:8181/DNPDatahub/api/citizenDetails?cid="+cid+"&token="+accessTokenData,   
                        data : $('form').serialize(),
                        cache : false,
                        dataType : "json",  
                        success : function(responseText, status, xhr) 
