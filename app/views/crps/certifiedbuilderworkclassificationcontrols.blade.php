	...
	<table class="table table-bordered table-striped table-condensed flip-content">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<input type="hidden" name="SpecializedfirmWorkClassificationModel[{{$randomKey}}][CrpContractorId]" value="{{$contractorId}}" class="tablerowcontrol" @if((bool)$projectCategory->CmnAppliedClassificationId==null){{"disabled=disabled"}} @endif/>
