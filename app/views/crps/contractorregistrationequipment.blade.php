		...
		<div class="portlet light bordered" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption font-green-seagreen">
					...
					<span class="caption-subject">Contractor Registration (New Application) </span> - <span class="step-title">Step 4 of 4 </span>
				</div>
			</div>
					...
					<div class="form-body">
											...
											<div class="table-responsive">
												<table class="table table-bordered table-striped table-condensed">
													...
													<tbody>
														<tr>
															<td>
																No equipment requirement for small class contractors.
															</td>
														</tr>
														<tr>
															<td>
						...
						<div class="table-scrollable">
							<table class="table table-bordered table-striped table-condensed flip-content">
								{{Form::hidden('Model','ContractorEquipmentModel',array('class'=>'delete-model'))}}
								...
								<tbody>
									...
									<tr>
										{{Form::hidden('Id',$contractorEquipment->Id,array('class'=>'rowreference'))}}
										<td>{{$contractorEquipment->Name}}</td>
										<td>{{$contractorEquipment->RegistrationNo or '-'}}</td>
										<td>
										...
										<td>
											@if((bool)$isEdit!=null)
											<a href="{{URL::to('contractor/equipmentregistration/'.$isEdit.'?equipmentid='.$contractorEquipment->Id)}}" class="editaction">Edit</a>&nbsp;|&nbsp;
											@endif
