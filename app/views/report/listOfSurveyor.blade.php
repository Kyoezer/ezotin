...
@if($type == 1)
	...
	<div class="portlet-body flip-scroll">
        @if(Input::get('export') != 'print')
            @if($type == 1)
                <?php 
                    $url = 'surveyorrpt/listofsurveyor'; 
                    $route="surveyorrpt.listofsurveyor";
                ?>
            @else
                <?php 
                    $url = 'surveyorrpt/listofsurveyorexpiring'; 
                    $route="surveyorrpt.listofsurveyorexpiring";?>
            @endif
