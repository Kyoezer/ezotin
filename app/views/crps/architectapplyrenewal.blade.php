		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							<a href="{{URL::to('architect/applyrenewalregistrationdetails/'.$architectId.'?redirectUrl=architect/profile')}}" class="btn green">Proceed <i class="fa fa-arrow-circle-o-right"></i></a>
							<a href="{{URL::to('architect/mydashboard')}}" class="btn red">Cancel <i class="fa fa-times"></i></a>
						</div>
					</div>
				</div>
			</div>
