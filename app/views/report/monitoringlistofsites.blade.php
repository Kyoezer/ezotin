	...
	<div class="portlet-body flip-scroll">
		...
		<div class="form-body">
			<div class="row">
                ...
                <div class="col-md-2">
                    <label class="control-label">Monitored From</label>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {{Form::select('Status',array('2'=>'Not Ok','1'=>'Ok'),Input::get('Status'),array('class'=>'form-control input-sm'))}}
                    </div>
                </div>
                @if(!Input::has('export'))
                    <div class="col-md-2">
        ...
        <?php pagination($noOfPages,Input::all(),Input::get('page'),"contractorrpt.monitoringlistofsites"); ?>
	</div>
</div>
@stop