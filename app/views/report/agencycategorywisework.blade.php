    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <i class="fa fa-cogs"></i>Agency Wise Category Wise Work Awarded and Completed &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route('etoolrpt.agencycategorywisework',$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route('etoolrpt.agencycategorywisework',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
            </div>
        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="Ministry" class="form-control">
                                ...
                                @foreach($ministries as $ministry)
                                    <option value="{{$ministry->Name}}" @if(str_replace('amp;','',Input::get('Ministry')) == $ministry->Name)selected="selected"@endif>{{$ministry->Name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
