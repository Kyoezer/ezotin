		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				@if((int)$hasAlreadyRequestedForCancellation==0)
					{{ Form::open(array('url' => 'architect/mcancelcertificate','role'=>'form','files'=>true))}}
					<blockquote>
						<div class="row">
							<div class="col-md-6">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
								<input type="hidden" value="{{$architectId}}" name="CrpArchitectFinalId" />
								<button type="submit" class="btn green">Submit <i class="fa fa-arrow-circle-o-right"></i></button>
								<a href="{{URL::to('architect/profile')}}" class="btn red">Cancel <i class="fa fa-times"></i></a>
							</div>
						</div>
					</div>
					{{Form::close()}}
