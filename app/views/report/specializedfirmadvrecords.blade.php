...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<i class="fa fa-cogs"></i>List of Specializedfirm having adverse records &nbsp;&nbsp;@if(!Input::has('export'))<?php $parameters['export'] = 'print'; ?><a href="{{route('specializedfirmrpt.specializedfirmwithadverserecords',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		</div>
	</div>
            ...
            <table class="table table-bordered table-striped table-condensed flip-content" >
                ...
                <tbody>
                    @foreach($reportData as $data)
                        ...
                        <td>{{html_entity_decode($data->AdverseRecords)}}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            <?php pagination($noOfPages,Input::all(),Input::get('page'),"specializedfirmrpt.specializedfirmwithadverserecords"); ?>
	</div>
</div>
@stop