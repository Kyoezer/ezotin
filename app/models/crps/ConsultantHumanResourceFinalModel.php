...
class ConsultantHumanResourceFinalModel extends BaseModel{
    ...
    public function scopeConsultantHumanResource($query,$reference){
        return $query->join('cmnlistitem as T1','T1.Id','=','crpconsultanthumanresourcefinal.CmnSalutationId')
                    ...
                    ->leftJoin('crpengineerfinal as T10','T10.CIDNo','=','crpconsultanthumanresourcefinal.CIDNo')
                    ->leftJoin('crparchitectfinal as T11','T11.CIDNo','=','crpconsultanthumanresourcefinal.CIDNo')
                    ->leftJoin('crpsurveyfinal as T12','T12.CIDNo','=','crpconsultanthumanresourcefinal.CIDNo')
