	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				...
				{{ Form::open(array('url' => 'contractor/mapprovecancelcertificate','role'=>'form'))}}
				...
				<div id="rejectregistrationcancellation" class="modal fade" role="dialog" aria-labelledby="rejectregistrationcancellation" aria-hidden="true">
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h3 class="modal-title font-green-seagreen">Reject Request</h3>
							</div>
							<div class="modal-body">
								<p class="bold">Are you sure you want to reject cancellation request for this application?</p>
							</div>
							<div class="modal-footer">
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							<input type="hidden" value="{{$contractorId}}" name="ContractorReference" />
							<input type="hidden" value="{{$cancelRequestId}}" name="CancelRequestId" />
							<input type="hidden" value="" name="Reject" value="0" id="Reject"/>
							<a href="#approveregistrationcancellation" onclick='document.getElementById("Reject").value=0' data-toggle="modal" class="btn green">Approve Cancellation Request</a>
							<a href="#rejectregistrationcancellation" onclick='document.getElementById("Reject").value=1' data-toggle="modal" class="btn purple">Reject Cancellation Request</a>
							<a href="{{URL::to('contractor/approvecertificatecancellationrequestlist')}}" class="btn red">Cancel <i class="fa fa-times"></i></a>
						</div>
					</div>
				</div>
				{{Form::close()}}
