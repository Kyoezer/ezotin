        ...
        <div>
            <div class="row">
                <div class="col-md-9" id="main_front">
                    <p class="home"><a href="{{ url('web/gnhjournal')}}">Current </a>/ Articles</p>
                    @foreach ($content as $detail)
                    <div class="landheading">{{ $detail->Name_of_Title }}</div><br>
                    ...
                    <div class="row">
                        ...
                        <h4 class="text-primary"><strong>Abstract</strong></h4>
                            @foreach($landingPage as $landingremarks)
                            {{$landingremarks->Landing_Remarks}}
                            @endforeach
                        </div>
