                            ...
                            <tr>
                                <td colspan="2" class="font-blue-madison bold warning">Enquiry Details
                                    <div class="pull-right"> 
                                        <a  href="{{URL::to('newEtl/seekclarification/'.$seekClaraificationDtls[0]->etlTenderId.'/'.$seekClaraificationDtls[0]->CDB_No.'/'.$contractorId)}}"  class="btn btn-primary btn-sm rounded-4">Go Back</a></div>
                                </td>  
                            </tr>
                            <tr>
