...
@if(isset($feeStructures))
     ...
     @elseif($mailIntendedTo == 4)

          <table class="data-large" style="border-collapse: collapse; width: 100%; background-color: #fff; font-size: 10pt;" bgcolor="#fff">
               <thead>
               <tr>
                    <th style="background-color: #d7e5f2; border: 1px solid #000;" bgcolor="#d7e5f2">Engineer Type</th>
                    <th style="background-color: #d7e5f2; border: 1px solid #000;" bgcolor="#d7e5f2">Application Type</th>
                    <th style="background-color: #d7e5f2; border: 1px solid #000;" bgcolor="#d7e5f2" width="20%" class="text-center">Validity (yrs)</th>
               ...
               @foreach($feeStructures as $feeDetail)
                    <tr>
                         @if($engineerServiceSectorType==CONST_CMN_SERVICESECTOR_GOVT)
                              <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right">Goverment</td>
                         @else
                              <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right">Private</td>
                         @endif
                         <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right">{{$feeDetail->ServiceName}}</td>
                         <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right" class="text-center">
                              @if(empty($feeDetail->RegistrationValidity))
                                   -
                              @else
                                   {{$feeDetail->RegistrationValidity}}
                         ...
                         <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right" class="text-right">
                              @if(empty($feeDetail->NewRegistrationFee))
                                   -
                              @else
                                   {{number_format($feeDetail->NewRegistrationFee,2)}}
               ...
               @endforeach
               <tr>
                    <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right" colspan="3" class="bold text-right">
                         Total
                    </td>
                    <td style="font-weight: bold;text-align: right;font-size: 10pt; background-color: #fff; padding: 2px; border: 1px solid #000;" bgcolor="#fff" align="right" class="text-right">
                         {{number_format($totalFeesApplicable,2)}}
