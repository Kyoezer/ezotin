...
public function __construct(){
    ...
    if($route != "cb/mydashboard"){
        $email = Auth::user()->Email;
        if(!(bool)$email){
            return Redirect::to('cb/mydashboard')->with('customerrormessage',"<strong>WARNING!</strong> To continue using CiNET, please update your email address.")->send();
        }
    }
    $userId = Auth::user()->Id;
