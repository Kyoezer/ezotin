            ...
            @forelse($contractorLists as $contractor)
                <tr>
                  ...
                  <td>{{$contractor->NAME}}</td>
                    ...
                    <td>{{convertDateToClientFormat($contractor->DeRegisteredDate)}}</td>
                    <td>{{$contractor->RefresherCourseModules}}</td>
                </tr>
                <?php $count++; ?>
            @empty
                <tr>
