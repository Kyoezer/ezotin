...
<div id="specializedtradecommentadverserecordedit" class="modal fade" role="dialog" aria-labelledby="specializedtradecommentadverserecordedit" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			{{ Form::open(array('url' => 'specializedtrade/meditcommentadverserecords','role'=>'form'))}}
			<input type="hidden" name="Id" class="specializedtradecommentadverserecordid" />
			<input type="hidden" name="CrpSpecializedTradeId" value="{{$specializedTrade[0]->Id}}" />
...
<a href="{{URL::to('specializedtrade/editcommentsadverserecordslist')}}" class="btn grey-cascade">Back to List</a>
					...
					@forelse($commentsAdverseRecords as $commentsAdverseRecord)
						@if((int)$commentsAdverseRecord->Type==2)
							<div class="note note-info">
								...
								<button type="button" class="btn bg-red-sunglo btn-sm deletespecializedtradeadverserecord">Delete</button>
							</div>
						@endif
					@empty
						<div class="note note-danger">
