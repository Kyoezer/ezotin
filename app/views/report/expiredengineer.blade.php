...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<i class="fa fa-cogs"></i>List of Expired Engineers &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route('engineerrpt.expiredengineer',$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route('engineerrpt.expiredengineer',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		</div>
	</div>
	<div class="portlet-body flip-scroll">
            ...
            @forelse($engineersList as $engineer)
				<tr>
                    ...
                    <td>{{$engineer->ExpiryDate}}</td>
							...
							@if($engineer->ExpiryDate<=date('Y-m-d G:i:s'))
							<p class="font-red bold warning">Expired</p>
							@else
							{{convertDateToClientFormat($engineer->ExpiryDate)}}
							@endif
        ...
        <?php pagination($noOfPages,Input::all(),Input::get('page'),"engineerrpt.expiredengineer"); ?>
	</div>
</div>
@stop