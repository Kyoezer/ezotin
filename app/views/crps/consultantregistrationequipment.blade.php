					...
					<div class="col-md-12 hide" id="equipment-details">
              		...
              		<div class="col-md-3">
						<div class="form-group">
							...
							<select name="CmnEquipmentId" id="" class="form-control select2me equipmentselectregisteredtype equipmentforwebservicemodal">
				...
				{{--<div class="row">--}}
					{{--<div class="col-md-3">--}}
						{{--<div class="form-group">--}}
							...
							{{--<input type="text" name="Quantity" value="@if(!empty($equipmentEditRecord->Quantity)){{$equipmentEditRecord->Quantity}}@else{{Input::old('Quantity')}}@endif" class="form-control disableifregisteredequipment" placeholder="Quantity">--}}
						{{--</div>--}}
					{{--</div>--}}
				{{--</div>--}}
				@endforeach
				...
				<div class="row">
					<div class="col-md-12 table-responsive">
						...
						<table id="consultanthumanresource" class="table table-bordered table-striped table-condensed">
							{{Form::hidden('Model','ConsultantEquipmentAttachmentModel',array('class'=>'delete-model'))}}
							<thead>
								<tr>
									<th>Document Name</th>
									<th>Action</th>
							...
							<tbody>
								...
								<tr>
									{{Form::hidden('Id',$equipmentAttachment->Id,array('class'=>'rowreference'))}}
									<td>
										<a href="{{URL::to($equipmentAttachment->DocumentPath)}}" class="editaction" target="_blank">{{$equipmentAttachment->DocumentName}}</a>
									</td>
									<td>
		...
		<div class="portlet light bordered" id="form_wizard_1">
			<div class="portlet-title">
				<div class="caption font-green-seagreen">
					...
					<span class="caption-subject">Consultant Registration</span> - <span class="step-title">Step 4 of 4 </span>
				</div>
			</div>
							...
							<div class="tab-pane active" id="tab4">
									...
									<div class="col-md-6">
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-condensed">
												<thead class="">
													<tr>
														<th colspan="5" class="bold">Mandatory Equipments</th>
													</tr>
													<tr>
														<th>Equipment</th>
														<th>C2</th>
												...
												<tbody>
													...
													<tr>
														<td>Four Terminal Earth Tester</td>
														<td>-</td>
														<td>-</td>
														<td>1</td>
														<td>1</td>
								...
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed flip-content">
										{{Form::hidden('Model','ConsultantEquipmentModel',array('class'=>'delete-model'))}}
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<i class="fa fa-check"></i> <a href="{{URL::to($equipmentsAttachment->DocumentPath)}}" class="font-blue">{{$equipmentsAttachment->DocumentName}}</a><br/>
													@endif
													@endforeach
												</td>
												<td>
													@if((bool)$isEdit!=null)
													<a href="{{URL::to('consultant/equipmentregistration/'.$isEdit.'?equipmentid='.$consultantEquipment->Id)}}" class="editaction">Edit</a>&nbsp;|&nbsp;
													@endif
