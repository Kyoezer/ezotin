    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <i class="fa fa-cogs"></i>HR and Equipment Details for WorkId {{Input::get('workid')}}
            </div>
        </div>
        <div class="portlet-body flip-scroll">
            @if(isset($tenderDetails[0]->TenderId) && $tenderDetails[0]->TenderId)
                ...
                <h4 class="bold">Occupied Equipment Details</h4>
                ...
                <h4 class="bold">Occupied Human Resource Details</h4>
                @foreach($bidContractors as $bidContractor)
                    <table class="table table-condensed table-bordered">
                        <thead>
                        <tr>
