    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <i class="fa fa-cogs"></i>CertifiedBuilder's Equipment &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route('cb.certifiedbuilderequipment',$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route('cb.certifiedbuilderequipment',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
            </div>
        </div>
