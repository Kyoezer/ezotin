...
<head>
    ...
    <style type="text/css">
        ...
        .navbar_submission {
            /* border-left: 4px dashed rgb(32, 103, 234); */
            border-left: 3mm ridge rgba(32, 103, 234, .6);
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    <div class="portlet-body form">
                        <h3 class="text-primary"><b>Submissions</b></h3>
                    </div>
                    <nav class="navbar_submission">
                        <div class="container">
                            <a href="journallogin"><strong>Login</strong></a>
                            or
                            <a href="journalregistration"><strong>Register</strong></a>
                            to make a submission.
                        </div>
                    </nav>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-11" id="headind-line">
                                <h3 class=""><strong>Submission Preparation Checklist</strong></h3>
                                    {{ HTML::decode($content) }}
                            </div>
                        </div>
                    </div>
