...
<div class="portlet light bordered">
		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group">
					...
					<input type="text" name="WorkOrderNo" value="" class="form-control">
				</div>
			</div>
	...
	{{--					@if((int)$underProcess==0)--}}
						...
						{{--@endif--}}
						<td>
							@if(Request::path()=="cb/editcompletedworklist" || Request::path()=="cb/worklist")
							<a href="{{URL::to('cb/workcompletionform/'.$lsitOfWork->Id)}}" class="btn default btn-xs green-seagreen"><i class="fa fa-edit"></i> View</a>
							@elseif(Request::path()=="cb/editbiddingformlist")
							<a href="{{URL::to('cb/biddingform?bidreference='.$lsitOfWork->Id)}}" class="btn default btn-xs green-seagreen editaction"><i class="fa fa-edit"></i> Edit</a>
							@endif
