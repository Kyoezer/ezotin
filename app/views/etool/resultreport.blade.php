            ...
            <table class="table table-bordered table-condensed table-small-font" id="table-print-small">
                ...
                @foreach($contractorScores as $contractorScore)
                    ...
                    <tr>
                        ...
                        <td>{{$contractorScore->Score7?number_format($contractorScore->Score7,2):0}}</td>
                        
                        
                        @if($IsBhutaneseEmp=='Y')
                            <td>{{$contractorScore->Score11?number_format($contractorScore->Score11,2):0}}</td>
                        @else
                        ...
                        <td>{{number_format($preferenceScore,2)}}</td>
