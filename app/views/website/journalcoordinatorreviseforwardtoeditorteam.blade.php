        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered"> 
                <div class="portlet-body form">  
                    ...
                    {{ Form::open(['url' => 'web/journalforwardtoeditorteam/']) }}
                    <div class="table-responsive card pmd-card">
                        <!-- Table -->
                        <table class="table pmd-table table-striped">
                            
                            <thead class="thead-dark">
                                <h3><b>Journal Coordinator </b><b id="Editor">( Managing Editor )</b>
                                <tr>
					...
					<th>Email:</th>
                            ...
                            <tr>
                                ...
                                @endforeach
                                            ...
                                            <tr>
                                                <th>
                                                    <h4 style="color:#107C10"><b>Reviewer 1 </b><b id="reviewer1_name"> ( Academician )</b></h4>
                                                </th>
                                            </tr>
                                    ...
                                    <th>Commented Manuscript:</th>
                                        <td>
                                            ...
                                            <tr>
                                                <th>
                                                    <h4 style="color:#107C10"><b>Reviewer 2 </b><b id="reviewer1_name"> ( Field Expert )</b></h4>
                                                </th>
                                            </tr>
