				...
				<table class="table table-bordered table-striped table-condensed flip-content">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{$workAwardedContractor->CDBNo}}</td>
	...
	<div class="portlet-body form">
		...
		<div class="form-body">
				...
				<div class="col-md-3">
					...
					<input type="hidden" name="Id" value="{{$contractDetails[0]->Id}}" />
						...
						<select name="CmnWorkExecutionStatusId" class="form-control required workcompletionstatuscontrol">
							...
							@foreach($workExecutionStatus as $workStatus)
                                <option value="{{$workStatus->Id}}" data-referenceno="{{$workStatus->ReferenceNo}}" @if($detailsOfCompletedWork->CmnWorkExecutionStatusId == $workStatus->Id)selected="selected"@endif>{{$workStatus->Name}}</option>
                            @endforeach
						</select>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<input type="text" class="form-control number range required workstatuscompletedcontrol" name="OntimeCompletionScore" value="{{$detailsOfCompletedWork->OntimeCompletionScore}}" data-min="0" data-max="30"/>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							<label class="control-label">Quality of Execution (out of 70) <span class="font-red">*</span></label>
							<input type="text" class="form-control number range required workstatuscompletedcontrol" name="QualityOfExecutionScore" value="{{$detailsOfCompletedWork->QualityOfExecutionScore}}" data-min="0" data-max="70"/>
						</div>
					</div>
				</div>
				<div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <textarea name="Remarks" class="form-control">{{$detailsOfCompletedWork->Remarks}}</textarea>
            </div>
		</div>
        @endforeach
