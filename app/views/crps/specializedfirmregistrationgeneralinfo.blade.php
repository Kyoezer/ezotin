...
{{ HTML::script('assets/global/scripts/specializedtrade.js') }}
	@if(empty($specializedtradeGeneralInfo[0]->Id) && (int)$serviceBySpecializedtrade==0)
	<script>
	 $('#specializedtradegeneralinforegistrationform').bootstrapValidator({
	    fields: {
	        NameOfFirm: {
	            validators: {
	                remote: {
	                    message: 'The Proposed Name for your firm is already taken. Try another name for your firm.',
	                   	url: "<?php echo CONST_SITELINK.'checkproposednamespecializedtrade'?>",
	                    delay: 2000
	                }
	            }
	        },
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-seagreen">
					...
					<span class="caption-subject">Specializedfirm Registration (New Application) </span> - <span class="step-title">Step 1 of 4 </span>
				</div>
			</div>
					...
					<div class="form-body">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								{{ Form::open(array('url' => 'specializedfirm/mspecializedtradegeneralinfo','role'=>'form','id'=>'specializedtradegeneralinforegistrationform','files'=>true))}}
								@include('crps.specializedfirmgeneralinfocontrols')
								{{Form::close()}}
							</div>
						</div>
					</div>
