<?php
class CBWorkCompletionForm extends CBController{
	...
	public function save(){
		...
		$workOrder = DB::table('cbbiddingform')->where('Id',$postedValues['Id'])->pluck('WorkOrderNo');
		...
		DB::table('cbbidequipment')->where('CrpBiddingFormId',$postedValues['Id'])->delete();
		DB::table('cbbidhumanresource')->where('CrpBiddingFormId',$postedValues['Id'])->delete();
