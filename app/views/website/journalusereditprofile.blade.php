    ...
    <div class="container">
        ...
        <div class="container" id="main">
            <div class="row">
                ...
                <p class="home"><b>Identity / </b><a href="journalcoordinatormytask"> Password </a></p>
                ...
                <hr>
                    ...
                    {{ Form::open(['url' => 'web/journalusereditprofile','method'=>'post']) }}
                    ...
                    <div class="form-group">
                        @foreach($content as $item)
                           ...
                           <input type="text" class="form-control" id ="contact" value="{{$item->Contact}}" name="contact">
