...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Work Distribution by Dzongkhag and Category
            </div>
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <hr/>
            <h4><i>Works awarded by category {{Input::has('FromDate')?" between ".Input::get('FromDate')." and ".(Input::has('ToDate')?Input::get('ToDate'):date('d-m-Y')):" as of ".(Input::has('ToDate')?Input::get('ToDate'):date('d-m-Y'))}}</i></h4>
