...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cogs"></i>Contractor's Information
            </div>
        </div>
                    ...
                    @forelse($reportData as $contractorList)
                        <tr>
                            ...
                            @if((int)$contractorList->StatusReference == 12003)
                                <a href="{{URL::to('contractor/certificate/'.$contractorList->Id)}}" class="btn default btn-xs blue" target='_blank'><i class="fa fa-edit"></i> View/Print</a>
                            @endif
                            </td>
                            <td>
                              
                                    <a href="{{URL::to('contractor/viewprintdetails/'.$contractorList->Id)}}" class="btn default btn-xs green-seagreen" target='_blank'><i class="fa fa-edit"></i> View/Print</a>
