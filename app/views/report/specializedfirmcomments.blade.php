...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<i class="fa fa-cogs"></i>List of Specializedfirm having comments &nbsp;&nbsp;@if(!Input::has('export'))  <?php $parameters['export'] = 'print'; ?><a href="{{route('specializedfirmrpt.specializedfirmwithcomments',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		</div>
	</div>
	<div class="portlet-body  flip-scroll">
        ...
        @endif
            ...
            <?php pagination($noOfPages,Input::all(),Input::get('page'),"specializedfirmrpt.specializedfirmwithcomments"); ?>
        </div>
</div>
@stop