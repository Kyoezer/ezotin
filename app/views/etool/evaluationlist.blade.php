...
<div class="portlet bordered light">
	...
	<div class="portlet-body flip-scroll">
        {{Form::open(array('url'=>'etl/evaluationetool','method'=>'get'))}}
        <div class="form-body">
            <div class="row">
                <div class="col-md-2">
        			...
        			<tbody>
                        ...
                        @forelse($uploadedTenders[$distinctYear->Year] as $tender)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('etl/evaluationcommiteeetool/'.$tender->Id)}}" class="btn default btn-xs bg-green-haze"><i class="fa fa-edit"></i> Evaluation Commitee</a>
                                    <a href="{{URL::to('etl/awardingcommiteeetool/'.$tender->Id)}}" class="btn default btn-xs purple"><i class="fa fa-edit"></i> Tender Commitee</a>
                                    <a href="{{URL::to(((($tender->Classification=='S') || $tender->Classification=='R'))
                                    ?'etl/workevaluationdetailssmallcontractors/'.$tender->Id:'etl/workevaluationdetails/'.$tender->Id)}}" class="btn default btn-xs bg-red-sunglo"><i class="fa fa-edit"></i> Details</a>
                                </td>
                            </tr>
