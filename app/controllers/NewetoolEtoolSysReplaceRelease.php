...
class NewetoolEtoolSysReplaceRelease extends EtoolController
{
    ...
    public function postFetch()
    {
        ...
        return View::make('new_etool.replacereleasedetails')
    ...
    public function getReplaceEquipment($id)
    {
        ...
        return View::make('new_etool.replaceequipment')
    ...
    public function getReleaseEquipment($id)
    {
        ...
        $registrationNo = DB::table('etlcontractorequipment')->where('Id', $id)->pluck('RegistrationNo');
        return View::make('new_etool.releaseequipment')
            ->with('registrationNo', $registrationNo)
            ->with('workId', $workId[0]->WorkId)
            ->with('Id', $id);
    }
    ...
    public function getReplaceHR($id)
    {
        ...
        return View::make('new_etool.replacehr')
            ->with('cidNo', $cidNo)
            ->with('workId', $workId[0]->WorkId)
            ->with('Id', $id);
    }
    ...
    public function getReleaseHR($id)
    {
        ...
        $cidNo = DB::table('etlcontractorhumanresource')->where('Id', $id)->pluck('CIDNo');
        return View::make('new_etool.releasehr')
            ->with('cidNo', $cidNo)
            ->with('workId', $workId[0]->WorkId)
            ->with('Id', $id);
    }
    ...
    public function getRequest()
    {
        ...
        return View::make('new_etool.requestreplacerelease')
            ->with('works', $works);
    }
    ...
    public function getRequestList()
    {
        ...
        return View::make('new_etool.requestreplacelist')
            ->with('start', $start)
    ...
    public function getDetails($id)
    {
        ...
        return View::make('new_etool.rrrequestdetails')
