        ...
        <div class="page-content">
            ...
            <div class="portlet light bordered">
                <div class="portlet-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-primary"><strong>The Page you are looking for does not exist!</strong></h2>
                            <i class="fa fa-arrow-left"></i>&nbsp;&nbsp;<a href="{{URL::to('/')}}">Return to home page</a>
                            <br>
                            <br>
                            <br>
                        </div>
...
{{ HTML::script('assets/global/scripts/common.js') }}
