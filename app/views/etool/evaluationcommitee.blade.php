	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Evaluation Committee
				</div>
			</div>
			<div class="portlet-body">
				{{Form::open(array('url'=>'etl/etlsavecommittee'))}}
				<div class="form-body">
                    ...
                    <div class="table-responsive">
						...
						<tbody>
                        @foreach($committee as $evalCommittee)
						...
						<tr>
							...
							<td>
								 <input type="hidden" class="form-control input-sm resetKeyForNew" name="EtlTenderCommitteeModel[{{$randomKey}}][Id]" value="{{$evalCommittee->Id}}" />
								 <input type="hidden" class="form-control input-sm resetKeyForNew notclearfornew" name="EtlTenderCommitteeModel[{{$randomKey}}][Type]" value="1" />
								 ...
								 <input type="text" class="form-control input-sm resetKeyForNew" name="EtlTenderCommitteeModel[{{$randomKey}}][Name]" value="{{$evalCommittee->Name}}" />
							</td>
							<td>
                                <input type="text" class="form-control input-sm resetKeyForNew" name="EtlTenderCommitteeModel[{{$randomKey}}][Designation]" value="{{$evalCommittee->Designation}}" />
							</td>
						</tr>
                        @endforeach
				...
				<div class="form-actions">
					<div class="btn-set">
                        ...
                        <a href="{{URL::to('etl/evaluationetool')}}" class="btn red">Cancel</a>
					</div>
				</div>
                {{Form::close()}}
			</div>
