			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="{{URL::to('architect/viewserviceapplicationdetails/'.$architectMyTaskList->Id)}}" class="btn default btn-xs green-seagreen processaction"><i class="fa fa-edit"></i> Details</a>
						</td>
					</tr>
					@empty
					<tr>
