...
class ReportListOfConsultants extends ReportController{
    public function getIndex(){
        ...
        $query = "select CDBNo, NameOfFirm, Address,Status, ExpiryDate, Dzongkhag, Country, TelephoneNo, MobileNo, CategoryA, CategoryC, CategoryE from viewlistofconsultants Where 1";
        ...
        if(Input::has('export')){
            ...
            if($export == 'excel'){
                Excel::create('List of Consultants', function($excel) use ($consultantsList, $country,$dzongkhag,$cdbNo,$classification,$limit,$fromDate,$toDate,$statusId) {
                    ...
                    $excel->sheet('Sheet 1', function($sheet) use ($consultantsList, $country,$dzongkhag,$cdbNo,$classification,$limit,$fromDate,$toDate,$statusId) {
                        ...
                        $sheet->loadView('reportexcel.listofconsultants')
        ...
        return View::make('report.listofconsultants')
                        ->with('start',$start)
