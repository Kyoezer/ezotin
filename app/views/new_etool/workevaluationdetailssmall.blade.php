...
<div id="cancelTender" class="modal fade" role="dialog" aria-labelledby="cancelTender" aria-hidden="true">
    ...
    <div class="portlet light bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                @if(!isset($contractor->ScoreId))
                                    <a href="{{URL::to('newEtl/smallWorkevaluationaddcontractors/'.$tenderId.'/'.$contractor->Id)}}" class="btn btn-xs bg-green-haze editaction"><i class="fa fa-edit"></i> Edit</a>
                                @else
		...
		<a href="#" class="cancelTender btn red btn-sm"><i class="fa fa-times"></i> Cancel Tender</a>
                    <a href="{{URL::to('newEtl/workevaluationsmallprocessresult/'.$tenderId)}}" class="btn blue-chambray btn-sm"><i class="fa fa-cogs"></i> Process Result</a>
                    <a href="{{URL::to('newEtl/smallWorkevaluationaddcontractors/'.$tenderId)}}" class="btn green btn-sm"><i class="fa fa-plus"></i> Add Contractors</a>
                    ...
                    @if($tender->CmnWorkExecutionStatusId != CONST_CMN_WORKEXECUTIONSTATUS_COMPLETED && $checkAwarded==false)
                        ...
                        <a href="{{URL::to('newEtl/workevaluationsmallresetresult/'.$tenderId)}}" class="btn red btn-sm"><i class="fa fa-refresh"></i> Reset Result</a>
                    @endif
                    @if($scoreCount > 0)
