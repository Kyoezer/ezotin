...
<div id="addcontractormodal" class="modal fade in" role="dialog" aria-labelledby="modalmessagebox" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {{Form::open(array('url'=>'newEtl/etlsaveaddcontractor'))}}
            <div class="modal-body">
			...
			<div class="portlet-body form flip-scroll">
                ...
                {{Form::hidden('CurrentTab',Input::has('currentTab')?'#'.Input::get('currentTab'):'#contractorhumanresource')}}
								...
								<div class="tabbable-custom nav-justified">
									...
									<div class="tab-content">
										<div class="tab-pane active" id="contractorhumanresource">
                                            ...
                                            <a target="_blank" href="{{URL::to('newEtl/seekclarification/'.$tenderId.'/'.$contractorCDBno.'/'.$contractorId)}}" class="btn default bg-green-haze">
                                                Seek clarification
                                            </a>
                                            @endif
                                            <br><br>
											...
											<table class="table table-bordered table-striped table-condensed flip-content table-togglecontrols" id="addcontractor-hr">
                                                ...
                                                ?>
													...
													<tr class="criteriaTr">
														...
														<td>
															<select name="EtlContractorHumanResource[{{$randomKey}}][Qualification]" id="" class="form-control input-sm EtlHrQualificationIdSPRR resetKeyForNew etool-total-SPRR">
																<option value="">---SELECT ONE---</option>
                                                    ...
                                                    <tr class="notremovefornew">
                                                        ...
                                                        <td><input type="text" readonly class="total form-control text-right not-required input-sm" value="{{($maxHrPoints!=0)?number_format((($hrTotal/.20)/$maxHrPoints * 20),3):''}}"/></td>
                                                    </tr>
												</tbody>
											</table>
										</div>
                                                ...
                                                <?php $eqTotal = 0; ?>
													...
													<tr class="eq-container">
														...
														<td>
														    ...
														    <select name="EtlContractorEquipment[{{$randomKey}}][OwnedOrHiredSPRR]" autocomplete="off" class="form-control input-sm resetKeyForNew etool-total-SPRR">
                                                                <option value="">---SELECT ONE---</option>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                ...
                                                                <input id="newpassword" class="form-control input-sm input-large resetKeyForNew registration-no checkEquipment not-required"
                                                                 value="{{$contEquipment->RegistrationNo}}" type="text"
                                                                  name="EtlContractorEquipment[{{$randomKey}}][RegistrationNo]" 
                                                    ...
                                                    <tr class="notremovefornew">
                                                        ...
                                                        <td><input readonly="readonly" class="text-right total form-control input-sm not-required" type="text" value="{{($maxEqPoints!=0)?number_format((($eqTotal/0.20)/$maxEqPoints * 20),3):''}}"/>
                                                        </td>
                                                    </tr>
												</tbody>
											</table>
					...
					<div class="form-actions">
						<div class="btn-set">
                            <a href="{{URL::to('newEtl/workevaluationdetails/'.$tenderId)}}" class="btn blue"><i class="m-icon-swapleft m-icon-white"></i>&nbsp;Back</a>
                            <button type="submit" class="btn green" id="saveAddContractor">Save</button>
							<a href="{{URL::to('newEtl/workevaluationdetails/'.$tenderId)}}" class="btn red">Cancel</a>
						</div>
					</div>
				{{Form::close()}}
				<!-- END FORM-->
...
<script>
    function checkTaxClearance(licenseNo,tpnNo)
    {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",   
            url: "http://119.2.120.14:8080/DNPDatahub/api/getTaxInformation?licenseNo="+licenseNo+"&tpnNo="+tpnNo+"&token="+accessTokenData,
    ...
    function checkTradeLicense(licenseNo)
    {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",   
            url: "http://119.2.120.14:8080/DNPDatahub/api/getLicenseDetails?licenseNo="+licenseNo+"&token="+accessTokenData,
            error: function(jqXHR, textStatus, errorThrown){
            $(".egpTenderIdErrorMessage").text("Something went wrong while trying to pull data from e-GP");
            $(".egpTenderIdErrorMessage").show();
            },
