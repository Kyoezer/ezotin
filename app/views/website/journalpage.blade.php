    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <img src="{{ asset('assets/cdb/layout/img/BCTA_journal.png') }}" alt="logo" class="img-responsive hidden-xs hidden-sm" />
    ...
    <div class="container">
        <nav class="navbar navbar-default navbar-static-top">
            ...
            <div class="collapse navbar-collapse col-md-9" id="bs-example-navbar-collapse-1">
                ...
                @endif
                <div class="col-md-5 @if (!($marqueeEnabled == 1 && Request::segment(1) == 'web' && Request::segment(2) == 'index')) @endif" id="search">
                    <form action="{{ URL::to('web/search') }}" method="GET" class="form-inline">
                        <div class="col-md-10" style="padding-right:0; padding-left:0;">
                            <input type="text" name="Term" value="{{ Input::get('Term') }}"
                                class="form-control input-md" placeholder="Search this website" style="width:100%;">
                        </div>
                        <div class="col-md-2" style="padding-left:0; padding-right:0;">
                            <button type="submit" class="btn btn-md btn-success"
                                style="width:100%;background:#26425e;"><i class="fa fa-search"></i>Search</button>
                        </div>
    ...
    <div>
        <div class="row">
            ...
            <div class="col-md-9" id="main_front">
                ...
                <p class="home"><a href="index">Home </a>/ current</p>
                <!-- <div id="heading"><p id="welcome"><b>Welcome To Construction Journal of Bhutan</b></p></div> -->
                <h4 class="text-primary"><strong>Current Issue</strong></h4>
                {{HTML::decode($contentmenu)}}
                </p>
                <!-- Striped table -->
                <br>
                <div class="clearfix"> <h4 class="titlediv"> Journal Articles</h4></div>
		<div>
                @foreach ($content as $detail)
                <ul class="list-group">
                    <li class="list-group-item" id="Title"><a href="{{ URL::to('web/journallandingpage/'.$detail->Id) }}">{{ $detail->Name_of_Title }}</a></li>
                    <li class="list-group-item">{{ ($detail->Name) }}</li>
                    <li class="list-group-item"><a href="{{ url($detail->File) }}" target="_blank">
                    <button type="button" class="btn2 danger">PDF <span class="fa fa-download"></button></a>
                    </li>
                </ul>
                @endforeach
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3" id="inner">
                        {{ HTML::decode($openaccess) }}
                        {{-- <br>ISSN: 2409-2797 (Print) <br>
			...
			<div class="col-md-3" id="submission">
                    ...
                    <div class="col-md-3" id="inner">
                        <br>
                        <p>Article Template    : <a href="{{ asset('/uploads/journal/filearticletemplate/.docx') }}"><b>Download File</b></a></p>
                        <p>Review Checklist     : <a href="{{ asset('/uploads/journal/filereviewerchecklist/.docx') }}"><b>Download File</b></a></p>                    </div>
                    <div class="col-md-3" id="submission">
                        <h4><strong>Information</strong></h4>
                    </div>
                    <div class="col-md-3" id="inner">
                        {{ HTML::decode($information) }}
                    </div>
                </div>
            </div>
        </div>
