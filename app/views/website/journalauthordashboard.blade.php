            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="portlet light bordered">
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="font-green-seagreen">Welcome <?php $userName = Session::get('userName'); ?>{{ $userName }}</h2>
			    ...
			    @foreach ($content as $item)
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{url('/web/journalmanuscript/' . $item->Id)}}" class="btn btn-success btn-lg">New Submission</a> <strong>or</strong>
                                <a href="{{url('/web/journalresubmission/' . $item->Id)}}" class="btn btn-info btn-lg">Re-submission</a> <strong>or</strong>
                                <a href="{{url('/web/journaleditprofile/' . $item->Id)}}" class="btn btn-primary btn-lg">Edit Profile</a>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th></th>
                                <td>
                                    <button class="btn btn-success">New Submission</button>
                                    <button class="btn btn-primary"> Re-submission</button>
                                    <button class="btn btn-"> Edit Profile</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
