                        ...
                        success: function(data){ 
                            if(data.length>0)
                            {
                                ...
                                for(var i =0;i<data.length;i++)
                                {
                                    ...
                                    "<input type='text' name='etlcriteriaequipment[<?=$randomKey?>"+i+"][Hired]' value='"+Hired+"'>");
                                }
                            }
                            else
                            {
                        ...
                        success: function(data){    
                            if(data.length>0)
                            {
                                ...
                                for(var i =0;i<data.length;i++)
                                {
                                    ...
                                    i++;  
                                    bQualification = data[i].valueBidder;  
                                    <?php $randomKey = randomString(); ?>


                                    
                                    $("#hrCriteria").append("<input type='text' name='etlcriteriahumanresource[<?=$randomKey?>"+i+"][EtlTierId]' value='"+tier+"'>"+
                                    ...
                                    "<input type='text' name='etlcriteriahumanresource[<?=$randomKey?>"+i+"][CmnSalutationId]' value='"+paPosition+"'>"+
                                    "<input type='text' name='etlcriteriahumanresource[<?=$randomKey?>"+i+"][Qualification]' value='"+bQualification+"'>");
                                }
                            }
                            else
                            {
