...
<div class="page-toolbar">
	<div id="dashboard-report-range" class="pull-right tooltips btn btn-fit-height grey-cascade" data-placement="top" data-original-title="Last used Engineer CDB No.">
		<span class="thin visible-lg-inline-block">Last used CDB No.: <span class="bold">{{lastUsedEngineerNo();}}</span></span>
	</div>
</div>
@stop
@section('content')
			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							@if(Route::current()->getUri()=="engineer/approveregistration")
								<a href="{{URL::to('engineer/approveregistrationprocess/'.$engineerMyTaskList->Id)}}" class="btn default btn-xs green-seagreen processaction"><i class="fa fa-edit"></i> Process</a>
							@elseif(Request::path()=="engineer/approvefeepayment")
								<a href="{{URL::to('engineer/approvepaymentregistrationprocess/'.$engineerMyTaskList->Id)}}" class="btn default btn-xs green-seagreen processaction"><i class="fa fa-edit"></i> Process</a>
							@else
								<a href="{{URL::to('engineer/verifyregistrationprocess/'.$engineerMyTaskList->Id)}}" class="btn default btn-xs green-seagreen processaction"><i class="fa fa-edit"></i> Process</a>
							@endif
			...
			<table class="table table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							@if(Route::current()->getUri()=="engineer/approveregistration")
								<a href="{{URL::to('engineer/lockapplication/'.$engineerList->Id.'?redirectUrl=engineer/approveregistration')}}" class="btn default btn-xs green-seagreen pickaction"><i class="fa fa-edit"></i> Pick</a>
							@elseif(Request::path()=="engineer/approvefeepayment")
							<a href="{{URL::to('engineer/lockapplication/'.$engineerList->Id.'?redirectUrl=engineer/approvefeepayment')}}" class="btn default btn-xs green-seagreen pickaction"><i class="fa fa-edit"></i> Pick</a>
							@else
								<a href="{{URL::to('engineer/lockapplication/'.$engineerList->Id.'?redirectUrl=engineer/verifyregistration')}}" class="btn default btn-xs green-seagreen pickaction"><i class="fa fa-edit"></i> Pick</a>
							@endif
						</td>
					</tr>
					@empty
