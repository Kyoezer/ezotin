...
class ReportListOfExpiredCertifiedBuilder extends ReportController{
    public function getIndex(){
        ...
        $query = "select * from expiredcertifiedbuilder Where 1";
        ...
        if(Input::has('export')){
            ...
            if($export == 'excel'){
                Excel::create('List of Expired Certified Builder', function($excel) use ($certifiedbuilderList, $country,$dzongkhag,$cdbNo,$limit,$fromDate,$toDate,$statusId) {
                    ...
                    $excel->sheet('Sheet 1', function($sheet) use ($certifiedbuilderList, $country,$dzongkhag,$cdbNo,$limit,$fromDate,$toDate,$statusId) {
                        ...
                        $sheet->loadView('reportexcel.expiredcertifiedbuilder')
        ...
        return View::make('report.expiredcertifiedbuilder')
                        ->with('start',$start)
