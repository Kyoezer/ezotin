...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
            ...
            @if(!Input::has('export'))
            <i class="fa fa-cogs"></i>List of Hr Registered with Contractors &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route("contractorrpt.listofregisteredhrwithcontractors",$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel </a>   <?php $parameters['export'] = 'print'; ?><a href="{{route("contractorrpt.listofregisteredhrwithcontractors",$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		    @endif
        </div>
	</div>
	<div class="portlet-body flip-scroll">
        @if(Input::get('export') != "print")
        {{Form::open(array('url'=>'contractorrpt/listofregisteredhrwithcontractors','method'=>'get'))}}
		<div class="form-body">
        <div class="row">
				<div class="col-md-2">
		...
		<table class="table table-bordered table-striped table-condensed flip-content" id="contractorhumanresource">
            ...
            <?php pagination($noOfPages,Input::all(),Input::get('page'),"contractorrpt.listofregisteredhrwithcontractors"); ?>
	</div>
</div>
@stop