...
<div class="portlet bordered light">
	...
	<div class="portlet-body flip-scroll">
        {{Form::open(array('url'=>'etl/workidetool','method'=>'get'))}}
        <div class="form-body">
            <div class="row">
                <div class="col-md-2">
                    <div class="form-group">
					...
					<table class="table table-bordered table-striped table-condensed flip-content">
			            ...
			            @forelse($uploadedTenders[$distinctYear->Year] as $uploadedTender)
							<tr>
								...
								<td>
									<a href="{{URL::to("etl/setcriteriaetool/$uploadedTender->Id")}}" class="btn default btn-xs bg-green-haze"><i class="fa fa-edit"></i> Set</a>
								</td>
							</tr>
						@empty
							<tr>
