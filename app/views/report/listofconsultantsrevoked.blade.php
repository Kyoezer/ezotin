...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
            <?php $route="consultantrpt.listofconsultantsrevoked"; $parameters = Input::all(); $parameters['export']='excel'; ?>
            @if(!Input::has('export'))
            <i class="fa fa-cogs"></i>List of Deregistered Consultants &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route("consultantrpt.listofconsultantsrevoked",$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel </a>   <?php $parameters['export'] = 'print'; ?><a href="{{route("consultantrpt.listofconsultantsrevoked",$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		    @endif
        </div>
	</div>
	<div class="portlet-body flip-scroll">
        @if(Input::get('export') != "print")
        {{Form::open(array('url'=>'consultantrpt/listofconsultantsrevoked','method'=>'get'))}}
		<div class="form-body">
			<div class="row">
                <div class="col-md-1">
