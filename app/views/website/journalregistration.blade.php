...
<div class="container-fluid" id="main">
    <div class="row">
        <div class="col-md-6" id="register">
            ...
            <h4 class="head"><strong>REGISTRATION</strong></h4><br>
            {{ Form::open(['url' => 'web/journalregister']) }}

            <div class="form-group">
                <label class="required" id="name">Name </label>
                <input type="text" name="name" class="form-control" placeholder="Enter your name.."
                    value="{{ Input::old('name') }}">
					@if ($errors->has('name'))<p class="error1">{{ $errors->first('name') }}</p>@endif
            </div>
            <div class="form-group">
			...
			<div class="form-group">
                <label class="required" id="cpassword">Confirm Password</label>
                <input type="password" name="confirm_password" class="form-control" placeholder="Enter your password again..">
				@if ($errors->has('confirm password'))<p class="error1">{{ $errors->first('confirm password') }}</p>@endif
            </div>
            <div class="form-group">
                <label class="required" id="contact">Contact</label>
                <input type="contact" name="contact" class="form-control" placeholder="Enter your contact number.."
                    value="{{ Input::old('contact') }}">
					@if ($errors->has('contact'))<p class="error1">{{ $errors->first('contact') }}</p>@endif
            </div>
