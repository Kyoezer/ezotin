...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
            <?php $route="specializedfirmrpt.listofspecializedfirmrevoked"; $parameters = Input::all(); $parameters['export']='excel'; ?>
            @if(!Input::has('export'))
            <i class="fa fa-cogs"></i>List of Revoked/Suspended/Debarred Specializedfirm &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route("specializedfirmrpt.listofspecializedfirmrevoked",$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel </a>   <?php $parameters['export'] = 'print'; ?><a href="{{route("specializedfirmrpt.listofspecializedfirmrevoked",$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		    @endif
        </div>
	</div>
	<div class="portlet-body flip-scroll">
        @if(Input::get('export') != "print")
        {{Form::open(array('url'=>'specializedfirmrpt/listofspecializedfirmrevoked','method'=>'get'))}}
		<div class="form-body">
			<div class="row">
                <div class="col-md-1">
                    <div class="form-group">
                        <label class="control-label">SP No.</label>
                        <input type="text" class="form-control" name="CdbRegistrationNo" placeholder="SP No."  value="{{Input::get('CdbRegistrationNo')}}" />
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
