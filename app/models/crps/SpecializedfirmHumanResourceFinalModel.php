...
class SpecializedfirmHumanResourceFinalModel extends BaseModel{
    ...
    public function scopeSpecializedtradeHumanResource($query,$reference){
        return $query->join('cmnlistitem as T1','T1.Id','=','crpspecializedtradehumanresourcefinal.CmnSalutationId')
                    ...
                    ->leftJoin('crpengineerfinal as T10','T10.CIDNo','=','crpspecializedtradehumanresourcefinal.CIDNo')
                    ->leftJoin('crparchitectfinal as T11','T11.CIDNo','=','crpspecializedtradehumanresourcefinal.CIDNo')
                    ->leftJoin('crpsurveyfinal as T12','T12.CIDNo','=','crpspecializedtradehumanresourcefinal.CIDNo')
                    ->leftJoin('crpspecializedtradefinal as T13','T13.CIDNo','=','crpspecializedtradehumanresourcefinal.CIDNo')
