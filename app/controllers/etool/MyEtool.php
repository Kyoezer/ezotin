<?php
class MyEtool extends EtoolController{
    ...
    public function getSelectChange(){
        ...
        $this->auditTrailEtoolCinet(NULL,NULL,$auditTrailActionMessage);
        return View::make('etool.selectchange');
    }
    public function getChangeAwarded(){
        ...
        if($workId){
            ...
            if(count($tender)>0){
                ...
                return Redirect::to('etl/etoolselectchange')->with('customerrormessage','No Work having this Work Id has been found');
            }
            ...
            return View::make('etool.changeawarded')
                            ->with('tenderEvaluationDetails',$tenderEvaluationDetails)
                            ->with('tender',$tender);
        }else{
            return Redirect::to('etl/etoolselectchange')->with('customerrormessage','Please enter a Work Id');
        }
    }
    ...
    public function seekclarification($tenderId,$cdbNo,$contractorId)
    {
        ...
        $this->layout->content =View::make('etool.seekClarificationList')
    ...
    public function viewseekclarification($id,$contractorId)
    {
        ...
        a.`Respond`,a.`Status`,a.`CDB_No`,b.`EGPTenderId` Tender_Id,a.`Tender_Id` etlTenderId ,a.`Created_On`
         ...
         LEFT JOIN etltender b ON a.`Tender_Id`=b.id
         WHERE a.`Id` = '".$id."'");
        $this->layout->content =View::make('etool.viewseekClarificationList')
    ...
    public function respondseekclarification($id)
    {
        ...
        $this->layout->content =View::make('etool.respondseekclarification')->with('seekClaraificationDtls',$seekClaraificationDtls);
	}
