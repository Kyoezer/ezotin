...
class ReportListOfSpecializedfirm extends ReportController{
    public function getIndex(){
        ...
        $query = "select SPNo, NameOfFirm, Address,Status,Name,Sex ,ExpiryDate,Email, Dzongkhag, Country, TelephoneNo, MobileNo, Category from listofspecializedfirm Where 1";
        ...
        if(Input::has('export')){
            ...
            if($export == 'excel'){
                Excel::create('List of Specialized Firm', function($excel) use ($specializedfirmList, $country,$dzongkhag,$cdbNo,$classification,$limit,$fromDate,$toDate,$statusId) {
                    ...
                    $excel->sheet('Sheet 1', function($sheet) use ($specializedfirmList, $country,$dzongkhag,$cdbNo,$classification,$limit,$fromDate,$toDate,$statusId) {
                        ...
                        $sheet->loadView('reportexcel.listofspecializedfirm')
        ...
        return View::make('report.listofspecializedfirm')
                        ->with('start',$start)
