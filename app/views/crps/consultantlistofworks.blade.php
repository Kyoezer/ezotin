		...
		<table class="table table-bordered table-striped table-condensed flip-content">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$lsitOfWork->ServiceCategory}}</td>
					<td>
						{{$lsitOfWork->ServiceCode}}
						<span class="font-green-seagreen tooltips" data-placement="top" data-original-title="{{$lsitOfWork->ServiceName}}"><i class="fa fa-question-circle"></i></span>
					</td>
					...
					@endif
					<td>
					@if(Request::path()=="consultant/editcompletedworklist" || Request::path()=="consultant/worklist")
						<a href="{{URL::to('consultant/workcompletionform/'.$lsitOfWork->Id)}}" class="btn default btn-xs green-seagreen"><i class="fa fa-edit"></i> View</a>
					@elseif(Request::path()=="consultant/editbiddingformlist")
						<a href="{{URL::to('consultant/biddingform?bidreference='.$lsitOfWork->Id)}}" class="btn default btn-xs green-seagreen editaction"><i class="fa fa-edit"></i> Edit</a>
					@endif
