...
<div class="portlet light bordered">
	...
	<div class="portlet-body flip-scroll">
		...
		<div class="col-md-2">
					<div class="form-group">
						...
						<select class="form-control" name="Classification">
							<option value="">---SELECT ONE---</option>
                            @foreach($specializedtradeClassifications as $specializedtradeClassification)
                                <option value="{{$specializedtradeClassification->Code}}" @if($specializedtradeClassification->Code == Input::get('Classification'))selected="selected"@endif>{{$specializedtradeClassification->Name.' ('.$specializedtradeClassification->Code.')'}}</option>
                            @endforeach
						</select>
					</div>
		</div>
		...
		<table class="table table-bordered table-striped table-condensed flip-content" id="contractorhumanresource">
		    ...
		    <td>{{$specializedtrade->Category}}</td>
