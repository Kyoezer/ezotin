		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				@if((int)$hasAlreadyRequestedForCancellation==0)
					{{ Form::open(array('url' => 'contractor/mcancelcertificate','role'=>'form','files'=>true))}}
					<blockquote>
						<div class="row">
							<div class="col-md-6">
						...
						<p class="text-justify">
							You are about to cancel your registration with Construction Development Board. Do you wish to proceed? Upon cancellation, your account will be inaccessible and you cannot re register with CDB for another three years.
						</p>
					</blockquote>
					<div class="col-md-4">
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-12">
								<input type="hidden" value="{{$contractorId}}" name="CrpContractorFinalId" />
