...
//            }
    ...
    public function reportDetails(){
        ...
        {
           $query ="SELECT `cid`,`name`,`gender`,`remarks`,`status` FROM t_monitoring_public_site_human_resources WHERE monitoring_public_site_id=".$inspectionId;
        }
        else if($reportType=='Public ongoing site_equipment')
        {
           $query =" SELECT  `vehicle_no`,`quantity`,`type` FROM t_monitoring_public_site_equipment WHERE monitoring_public_site_id=".$inspectionId;
        }
        ...
        {
            $query =" SELECT `inspectionId`, `workId`, `procuringSiteEngineerName`, `hasAps`, `hasApsRemarks`, `hasOffice`, 
            `hasOfficeRemarks`, `hasSignboard`, `hasSignboardRemarks`, `hasStore`, `hasStoreRemarks`, `hasAccommodation`, 
            `hasAccommodationRemarks`, `hasSanitary`, `hasSanitaryRemarks`, `hasPotableWater`, `hasPotableWaterRemarks`, 
            `hasWorkInsurance`, `hasWorkInsuranceRemarks`, `hasLabourInsurance`, `hasLabourInsuranceRemarks`, `hasThirdPartyInsurance`,
             `hasThirdPartyInsuranceRemarks`, `hasWorkPlan`, `hasWorkPlanRemarks`, `workStatus`, `workStatusRemarks`, `hasBoq`, 
             `hasBoqRemarks`, `hasContractConditions`, `hasContractConditionsRemarks`, `hasApprovedDrawing`, `hasApprovedDrawingRemarks`,
              `hasWorkSpecifications`, `hasWorkSpecificationsRemarks`, `hasSiteOrderBook`, `hasSiteOrderBookRemarks`, 
              `hasHindranceRegister`, `hasHindranceRegisterRemarks`, `hasMbs`, `hasMbsRemarks`, `hasCms`, `hasCmsRemarks`, `hasJournal`,
               `hasJournalRemarks`, `hasQualityAssurancePlan`, `hasQualityAssurancePlanRemarks`, `hasQualityControlPlan`, 
               `hasQualityControlPlanRemarks`, `hasTestReport`, `hasTestReportRemarks`, `hasLocalMaterials`, `hasLocalMaterialsRemarks`,
                `hasSpecializedTrade`, `hasSpecializedTradeRemarks`, `hasOhsIncharge`, `hasOhsInchargeRemarks`, `hasSafetySignages`, 
                `hasSafetySignagesRemarks`, `hasFireExtinguishingEquipment`, `hasFireExtinguishingEquipmentRemarks`, `hasFirstAidBox`,
                 `hasFirstAidBoxRemarks`, `hasPeripheralBoundary`, `hasPeripheralBoundaryRemarks`, `hasProperElectricalInstallations`, 
                 `hasProperElectricalInstallationsRemarks`, `hasCctv`, `hasCctvRemarks`, `nationalLabours`, `foreignLabours`, `internNo`,
                  `vtiGraduates`, `latitude`, `longitude`, `localityName`, `representativeName`, `representativeCidNo`, 
                  `representativeContactNo`, `siteEngineerName`, `remarks`, `createdBy`, `createdOn` FROM 
                  `t_monitoring_public_site_inspection` 
