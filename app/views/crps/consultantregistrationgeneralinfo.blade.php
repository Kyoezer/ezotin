...
{{ HTML::script('assets/global/scripts/consultant.js') }}
    @if(empty($consultantGeneralInfo[0]->Id) && (int)$serviceByConsultant==0)
	<script>
	 $('#consultantgeneralinforegistrationform').bootstrapValidator({
        fields: {
            NameOfFirm: {
                validators: {
                    remote: {
                        message: 'The Proposed Name for your firm is already taken. Try another name for your firm.',
                        url: "<?php echo CONST_SITELINK.'checkproposednameconsultant'?>",
                        delay: 2000
                    }
                }
            },
		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-green-seagreen">
					...
					<span class="caption-subject">Consultant Registration</span> - <span class="step-title">Step 1 of 4 </span>
				</div>
			</div>
					...
					<div class="form-body">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								{{ Form::open(array('url' => 'consultant/mconsultantgeneralinfo','role'=>'form','id'=>'consultantgeneralinforegistrationform','files'=>true))}}
								@include('crps.consultantgeneralinfocontrols')
								{{Form::close()}}
							</div>
						</div>
					</div>
