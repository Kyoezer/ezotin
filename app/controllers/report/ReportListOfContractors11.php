...
class ReportListOfContractors extends ReportController
{
    public function getIndex(){
        ...
        if(Input::has('export')){
            ...
            if($export == 'excel'){
                Excel::create('List of Contractors', function($excel) use ($contractorLists,$parametersForPrint) {
