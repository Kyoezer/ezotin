...
@section('content')
    <div class="portlet light bordered">
        @foreach($equipmentDetails as $details)
        
        <div class="portlet-body flip-scroll">
            @if(Input::get('export')!='print')
            {{Form::open(array('url'=>'certifiedbuilder/replaceCinetEquipment','method'=>'post'))}}
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-sm" value="{{$details->RegistrationNo}}"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
