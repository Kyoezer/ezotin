	...
	<div class="col-md-12">
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
					...
					<div class="col-md-6">
						<table class="table table-bordered table-striped table-condensed flip-content">
							<tbody>
								...
								<tr>
									<td><strong>Engineer Type</strong></td>
									<td>{{$generalInformation[0]->EngineerType}}</td>
								</tr>
								<tr>
									<td><strong>Trade</strong></td>
									<td>{{$generalInformation[0]->Trade}}</td>
								</tr>
								<tr>
									<td><strong>Name</strong></td>
									<td>{{$generalInformation[0]->EngineerName}}</td>
								</tr>
								<tr>
				...
				{{ Form::open(array('url' => 'engineer/mapprovecancelcertificate','role'=>'form'))}}
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							<input type="hidden" value="{{$engineerId}}" name="EngineerReference" />
							...
							<a href="{{URL::to('engineer/approvecertificatecancellationrequestlist')}}" class="btn red">Cancel <i class="fa fa-times"></i></a>
						</div>
					</div>
				</div>
				{{Form::close()}}
