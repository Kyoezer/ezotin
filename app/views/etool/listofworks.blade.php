...
<div class="portlet light bordered">
	...
	<div class="portlet-body">
        {{Form::open(array('url'=>'etl/listofworksetool','method'=>'get'))}}
		<div class="form-body">
			<div class="row">
                <div class="col-md-2">
		...
		<table class="table table-bordered table-striped table-condensed flip-content">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="{{URL::to('etl/workcompletionformetool/'.$tender->Id)}}" class="btn default btn-xs green-seagreen editaction"><i class="fa fa-edit"></i> Edit</a>
					</td>
				</tr>
				@empty
					<tr>
