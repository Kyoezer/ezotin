...
<body>
    ...
    <div class="container">
        ...
        @endif
        @if (Session::get('resubmit'))
			<div class="alert alert-success alert-block text-center">
				<button type="button" class="close" data-dismiss="alert">x</button>
				<strong>{{ Session::get('resubmit') }}</strong>
			</div>
			@endif
	@foreach ($content as $item)
        <?php if ($item->Task_Status_Id != 7) { ?>
                ...
                <div class="row">
                    <div class="col-md-10" id="author">
                        <div class="col-md-6">
                            <table class="table pmd-table table-striped">
                                <thead class="thead-dark">
                                    <h4><b>Reviewer 1 Details</b><b id="reviewer1_name">( Academician )</b></h4>
                                </thead>
                                <tbody class="fond">
                                    @foreach ($content as $item)
                                    <tr>
                                    ...
                                    <?php if ($item->Task_Status_Id == 21) { ?>
                                        <tr>
                                            <th>File send from Journal Coordinator:</th>
                                            <td>
                                                <a href="{{ asset($item->File_Attachment) }}" target="_blank">
                                                    <b>Download File</b>
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Remark from Journal Coordinator:</th>
                                            <td>{{ $item->JCremark_After_revised_Rejected }}</td>
                                        </tr>
                                    <?php } else if ($item->Task_Status_Id == 16) { ?>
                                        <tr>
                                            <th>Remark from Journal Coordinator:</th>
                                            <td>{{ $item->Remark_By_JC_toAuthor }}</td>
                                        </tr>
                                    <?php } else { ?>
                                    <?php } ?>
                        ...
                        <div class="col-md-6">
                            <table class="table pmd-table table-striped">
                                <thead class="thead-dark">
                                    <h4><b>Reviewer 2 Details</b><b id="reviewer1_name">( Field Expert )</b></h4>
                                </thead>
                                <tbody class="fond">
                                    @foreach ($content as $item)
                                    <tr>
                    ...
                    <?php if ($item->Task_Status_Id == 16) { ?>
                        <div class="col-md-10" id="author">
                            {{ Form::open(['url' => 'web/journalforwardtojcbyauthor/', 'files'=>true]) }}
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input class="center-block" type="file" name="file_forwarded_to_jc_by_author"> <br>
                                                    @if ($errors->has('file'))
                    ...
                    <?php } else if ($item->Task_Status_Id == 21) { ?>
                        <div class="col-md-10" id="author">
                            {{ Form::open(['url' => 'web/journalforwardagaintojcbyauthor/', 'files'=>true]) }}
                            <div class="table-responsive card pmd-card">
                                <!-- Table -->
                                <table class="table pmd-table table-striped">
                                    <thead class="thead-dark">
                                    ...
                                    <tbody class="fond">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input class="center-block" type="file" name="file_forwarded_again_to_jc_by_author"> <br>
                                                    @if ($errors->has('file'))
                                                    <p class="error1">{{ $errors->first('file') }}</p>
                                                    @endif
                                                </div>
                ...
                <div class="row">
                    <div class="col-md-10" id="author">
                        <div class="col-md-12">
                            <table class="table pmd-table table-striped">
                                <thead class="thead-dark">
                                    <th style="color:red"><h3><b>Notification</b></h3></th>
                                </thead>
                                <tbody class="fond">
                                    @foreach ($content as $item)
                                    <tr>
                                        <th class="width">Remarks by Journal Coordinator (Managing Editor):</th>
                                        <td>
                                        {{ $item->Rejected_Remark_from_JC }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="width">Your Manuscript:</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th>Turnitin Report:</th>
                                        <td>
                                            <a href="{{ asset($item->File_Turnitin_Report) }}" target="_blank">
                                                <b>Download File</b>
                                            </a>
                                        </td>
                                    </tr>
                    ...
                    <?php if ($item->Task_Status_Id == 7) { ?>
                        <div class="col-md-10" id="author">
                            {{ Form::open(['url' => 'web/journalforwardtojcafterrejecting/', 'files'=>true]) }}
                            <div class="table-responsive card pmd-card">
                                <!-- Table -->
                                <table class="table pmd-table table-striped">
                                    <thead class="thead-dark">
                                    ...
                                    <tbody class="fond">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input class="center-block" type="file" name="file_forwarded_to_jc_after_rejecting"> <br>
                                                    @if ($errors->has('file'))
                                                    <p class="error1">{{ $errors->first('file') }}</p>
                                                    @endif
                                                </div>
