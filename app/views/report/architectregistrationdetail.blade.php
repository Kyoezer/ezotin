...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
            <?php $parameters = Input::all(); $parameters['export']='excel'; $route = 'architectrpt.architectregistrationdetail';?>
            @if(!Input::has('export'))
            <i class="fa fa-cogs"></i>Architect Registration Details &nbsp;&nbsp;@if(!Input::has('export'))   <?php $parameters['export'] = 'print'; ?><a href="{{route($route,$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		    @endif
        </div>
	</div>
	<div class="portlet-body flip-scroll">
			...
			<div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="ArchitectName" value="{{Input::get('ArchitectName')}}" class="form-control"/>
                    </div>
                </div>
                @if(!Input::has('export'))
                    <div class="col-md-2">
		...
		<table class="table table-bordered table-striped table-condensed flip-content" id="contractorhumanresource">
            ...
            @forelse($reportData as $data)
				<tr>
                    <td>{{$data->NameOfFirm}} ({{$data->ARNo}})</td>
