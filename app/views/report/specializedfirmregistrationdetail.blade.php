...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
            <?php $parameters = Input::all(); $parameters['export']='excel'; $route = 'specializedfirmrpt.specializedfirmregistrationdetail';?>
            @if(!Input::has('export'))
            <i class="fa fa-cogs"></i>Specialized Firm Registration Details &nbsp;&nbsp;@if(!Input::has('export'))   <?php $parameters['export'] = 'print'; ?><a href="{{route($route,$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		    @endif
        </div>
	</div>
			...
			<div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="SpecializedfirmName" value="{{Input::get('SpecializedfirmName')}}" class="form-control"/>
                    </div>
                </div>
                @if(!Input::has('export'))
                    <div class="col-md-2">
