...
<div class="portlet light bordered" id="form_wizard_1">
	...
	<div class="portlet-body form">
		<div class="form-body">
			...
			<div class="row">
                <div class="col-md-12">
					<a href="{{URL::to('architect/registration/'.$architectId.'?editbyapplicant=true')}}" class="btn green-seagreen editaction">
            ...
            <div class="row">
            	<div class="col-md-12">
					...
					<span class="bold">I declare and confirm that:-</span>
					<ul>
