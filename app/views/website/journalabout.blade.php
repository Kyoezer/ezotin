    ...
    <div>
            <div class="row">
                <div class="col-md-9" id="main_front">
                    <p class="home"><a href="gnhjournal">Current </a>/ About the Journal</p>
                    <h4 class="text-primary"><strong>About Journal</strong></h4>
                    {{ HTML::decode($content) }}
                </div>
                <div class="container">
                    <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-key"></i>&nbsp;<a
                                    href="{{ URL::to('web/eventcalendar') }}">Events</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-key"></i>&nbsp;<a
                                    href="{{ URL::to('web/viewforum') }}">Forum</a>
                            </li>
                            <li><i class="fa fa-key"></i>&nbsp;<a
