            ...
            <div class="row">
                <div class="col-md-10" id="author">
                    <div class="col-md-offset-2 col-md-8">
                        {{ Form::open(['url' => 'web/journaldetailsendtoauthor','method'=>'post']) }}
                        <div class="collapse navbar-collapse">
                        <label><strong><h3>Resubmission</h3></strong> </label>
                            <div class="form-group">
                                <input class="form-control" name="Application_No" type="text" value="{{Input::get('Application_No')}}" placeholder="Enter your Application Number">
                            </div>
