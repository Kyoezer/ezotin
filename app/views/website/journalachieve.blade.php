    ...
    <div class="container">
            ...
            <div class="col-md-5 @if (!($marqueeEnabled == 1 && Request::segment(1) == 'web' && Request::segment(2) == 'index'))  @endif" id="search">
                <form action="{{ URL::to('web/search') }}" method="GET" class="form-inline">
                    <div class="col-md-10" style="padding-right:0; padding-left:0;">
                        <input type="text" name="Term" value="{{ Input::get('Term') }}" class="form-control input-md" placeholder="Search this website" style="width:100%;">
                    </div>
        ...
        <div class="row">
            <div class="col-md-9" id="main_front">
                ...
                <h4><strong>CDB Construction Journal of Bhutan</strong></h4><br>

                <div class="panel-group" id="accordion">

                    @foreach ($achievements as $year => $achievementsOfYear)
                        <div class="panel panel-default">
                            <div class="panel-heading" id="panel">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse{{ $year }}">{{ $year }}</a>
                                </h4>
                            </div>
                            <div id="collapse{{ $year }}" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @foreach ($achievementsOfYear as $detail)
                                                <tr>
                                                    <td><a href="{{ URL::to('web/journallandingpage/'.$detail->Id) }}" class="title">{{ $detail->Name_of_Title }}</a></td>
                                                </tr>
                                                <tr>
                                                    <td class="title2">{{ $detail->Name }}</td>
                                                </tr>
                                                <td>
                                                    <a href="{{ url($detail->File) }}" target="_blank">
                                                        <button type="button" class="btn2 danger">PDF <span class="fa fa-download"></span></button>
                                                    </a>
                                                    <br><br><br>
                                                    <div class="clearfix"></div>
                                                </td>
        ...
        <div class="bg-footer footer">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6">
                        <ul class="list-unstyled">
                            <li><i class="fa fa-key"></i>&nbsp;<a href="{{ URL::to('web/allvideos') }}">TV
                                    Spot</a>
                            </li>
                            <li><i class="fa fa-key"></i>&nbsp;<a href="{{ URL::to('web/sitemap') }}">Site
                                    Map</a>
                            </li>
                        </ul>
                    </div>
