    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <i class="fa fa-cogs"></i>@if((int)$type == 1)<?php $route = "etoolrpt.apscontractorcompleted"; ?>{{"APS"}}@elseif((int)$type ==2)<?php $route = "etoolrpt.apscontractorontime"; ?>{{"Ontime Completion score"}}@else<?php $route = "etoolrpt.apscontractorquality"; ?>{{"Quality of Execution score"}}@endif of completed contractors &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route($route,$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route($route,$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
            </div>
        </div>
