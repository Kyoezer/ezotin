		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
				@foreach($mainMenus as $mainMenu)
					<li class="dropdown" @if($mainMenu->ReferenceNo == 1)
					data-rel="tooltip" data-original-title="Ezotin is composure of online Services rendered by CDB Secretariat. It has the following applications incorporated with it:
CRPS,
eTool,
...
<div class="container">
    ...
    <div class="row">
		...
		@endif
		<div class="col-md-5 @if(!($marqueeEnabled == 1 && Request::segment(1) == 'web' && Request::segment(2)=='index')){{'col-md-offset-7'}}@endif">
