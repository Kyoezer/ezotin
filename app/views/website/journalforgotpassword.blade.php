	...
	<div class="portlet-body">
		<div class="row">
			...
			<div class="col-md-5">
				...
				{{ Form::open(array('url' => 'web/jresetandsendpassword','role'=>'form'))}}
			        ...
			        <div class="form-group">
			            ...
			            <div class="input-icon">
			                ...
			                <input class="form-control required input-xlarge placeholder-no-fix" type="text" placeholder="Username" name="email"/>
			            </div>
			        </div>
