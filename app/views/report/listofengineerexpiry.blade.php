...
<div class="portlet light bordered">
	<div class="portlet-title">
		<div class="caption">
			...
			<i class="fa fa-cogs"></i>List of Engineers &nbsp;&nbsp;@if(!Input::has('export')) <a href="{{route('engineerrpt.listofengineerexpiry',$parameters)}}" class="btn btn-sm green"><i class="fa fa-file-excel-o"></i> Export to Excel</a>    <?php $parameters['export'] = 'print'; ?><a href="{{route('engineerrpt.listofengineerexpiry',$parameters)}}" class="btn btn-sm purple" target="_blank"><i class="fa fa-print"></i> Print</a>@endif
		</div>
	</div>
	<div class="portlet-body flip-scroll">
        ...
        <?php pagination($noOfPages,Input::all(),Input::get('page'),"engineerrpt.listofengineerexpiry"); ?>
	</div>
</div>
@stop