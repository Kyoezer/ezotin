...
class ReportListOfEngineers extends ReportController{
    public function getIndex(){
        ...
        $query = "select CDBNo,Sector, Trade, Status, CIDNo,EngineerName, ApprovedDate,ExpiryDate, Dzongkhag, Country, Gewog,Village,Email, MobileNo from viewlistofengineers Where 1";
        ...
        return View::make('report.listofengineers')
                        ->with('start',$start)
